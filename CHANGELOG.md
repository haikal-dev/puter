...
* add API to get a list of all available models ([#1160](https://github.com/haikal-dev/puter/issues/1160)) ([004e47a](https://github.com/haikal-dev/puter/commit/004e47a4a9693e625425348c48f3fe3e4ebccd66))
* create and export UsageLimitedChatService  ([#1182](https://github.com/haikal-dev/puter/issues/1182)) ([bf3d63a](https://github.com/haikal-dev/puter/commit/bf3d63a083838c7f7002d7d6e483f55e95587657))
* disable creation of temp_users and user signup through config ([8d5860d](https://github.com/haikal-dev/puter/commit/8d5860d733ffccc363e79da7fb667eaea56d53b5))
* enhanced ai command to perfom other commands ([#1156](https://github.com/haikal-dev/puter/issues/1156)) ([7ed779b](https://github.com/haikal-dev/puter/commit/7ed779bbf384a2a559b642c553ec2c0e0de02ada))
* essential configuration options for deployers ([3666b9f](https://github.com/haikal-dev/puter/commit/3666b9f3a25127909940c988164ff61ec3c2ea99))
* GUI Permission Dialog ([#1177](https://github.com/haikal-dev/puter/issues/1177)) ([3cdbcd8](https://github.com/haikal-dev/puter/commit/3cdbcd83b33362a3ad731ebb593a58dade1875bc))
* hash-based distributed cache inval ([d386096](https://github.com/haikal-dev/puter/commit/d38609646793a5a14b8af96964fc7176725a0531))
* UIAlert with dynamic icon types and default button configurations ([#1175](https://github.com/haikal-dev/puter/issues/1175)) ([a278a61](https://github.com/haikal-dev/puter/commit/a278a6140bab32fddbf44226f551765481f7b8d9))


### Bug Fixes

* --onlycase param broke cartesian tests ([d9822a4](https://github.com/haikal-dev/puter/commit/d9822a4f09e3e0c5fbed8c655435f534af949290))
* acl check for subdomain on access ([c69006e](https://github.com/haikal-dev/puter/commit/c69006e1852befa93f94a7c45651025214941a4e))
* actor param in legacy /write ([7aa886d](https://github.com/haikal-dev/puter/commit/7aa886d573362e6739bd99bbed02f4831557ccb4))
* add package-lock.json ([3097b86](https://github.com/haikal-dev/puter/commit/3097b86597218de9e59b450b70185634a94be210))
* add type=text ([e2797c3](https://github.com/haikal-dev/puter/commit/e2797c38d0754930033780d5270cc64cbba2c94e))
* allow command provider to not implement complete method ([2000b89](https://github.com/haikal-dev/puter/commit/2000b8909f08d91147b86fce22fe006e0c3152d2))
* allow localhost for development ([ad8a397](https://github.com/haikal-dev/puter/commit/ad8a3978c07e44f7a534981ddd65bc131c9aac6b))
* app data check error in write ([5ef75e5](https://github.com/haikal-dev/puter/commit/5ef75e5df35ae95242da97235512495b7585bd0d))
* app icon double-encode bug ([23eab63](https://github.com/haikal-dev/puter/commit/23eab63776a146a78b10e973518158fc07b13653))
* app icon empty string should be skipped ([37ca892](https://github.com/haikal-dev/puter/commit/37ca89228cc2f978602098ee4aae1ecb3d333526))
* appease mocha's import requirements ([d6bbba7](https://github.com/haikal-dev/puter/commit/d6bbba7bf064991d59fbfe74db5221e0118a781c))
* AppES PD alert ([f14e1fe](https://github.com/haikal-dev/puter/commit/f14e1fefcf18438bd59eb86d625b8c5a6fb3ffc5))
* AppInformationService initialization ([2332602](https://github.com/haikal-dev/puter/commit/233260233c4e52399541aedbf8b13800de80d3fd))
* attempt fix for prod issue with app icons ([925ebd5](https://github.com/haikal-dev/puter/commit/925ebd531013e36ee5c05d53ef229d314fb89435))
* bad uuid reference to resourceService ([13003c4](https://github.com/haikal-dev/puter/commit/13003c486fbebad0f26dd1b569f5fd5f2cefc9e7))
* broken test in putility ([a803d55](https://github.com/haikal-dev/puter/commit/a803d55cfbdd5b15e7fe48df3f4363c1658f0930))
* buffer incomplete JSON objects from AI stream ([60eef2f](https://github.com/haikal-dev/puter/commit/60eef2fc6734f88df06e2f85db9b9368cc8c227f))
* check if row.timestamp is Date ([5d049e8](https://github.com/haikal-dev/puter/commit/5d049e8f06dafe2e499ccfea66ef013a9b595396))
* circular imports ([8fabf01](https://github.com/haikal-dev/puter/commit/8fabf014a9eb783183e87489ae2b6c6bbc42c99a))
* claude duplicate messages in stream ([0fac03a](https://github.com/haikal-dev/puter/commit/0fac03a05a4f597f7ed531651c830e44012b646b))
* clone message object ([728ecbf](https://github.com/haikal-dev/puter/commit/728ecbfb033082186ca9480f2ab2d1607b57ca5a))
* database issue with KBKV update ([7ba1b76](https://github.com/haikal-dev/puter/commit/7ba1b7656b5e24375cad639b9a8e37577b526c09))
* dev center app icon SVG issue ([47a4313](https://github.com/haikal-dev/puter/commit/47a4313d92152b9e5b4036715ac4f19431be8940))
* dev-center undefined error ([794778d](https://github.com/haikal-dev/puter/commit/794778d665b0ae6dfa92b727a5f88fc604e982cd))
* don't call /rao in gui ([7deb0c5](https://github.com/haikal-dev/puter/commit/7deb0c56925e3ce867c0d6e19a240827943405db))
* don't show register when user signup is disabled ([ad7b7b9](https://github.com/haikal-dev/puter/commit/ad7b7b951345bb23c9010c8e3509673412c5d6d3)), closes [#1087](https://github.com/haikal-dev/puter/issues/1087)
* empty response when mkdir is a no-op ([f359ae1](https://github.com/haikal-dev/puter/commit/f359ae193e87552b3a2e2aafa3fda389478fca38))
* ensure puter.signup emit resolves ([113ed31](https://github.com/haikal-dev/puter/commit/113ed31336c494a3f7a9e744a34de35b3785c033))
* error msg for invalid puter-ocr urls ([6a6bfa0](https://github.com/haikal-dev/puter/commit/6a6bfa034fe16dba7172ab5adbf23f00df38301d))
* errors after stream starts ([759c32a](https://github.com/haikal-dev/puter/commit/759c32ac726461202323d97309828160cd6dc1a0))
* file manager sidebar headings contrast ([#1191](https://github.com/haikal-dev/puter/issues/1191)) ([dab5e0a](https://github.com/haikal-dev/puter/commit/dab5e0a281c1749ef969d0eefb45b39fda8ce496))
* first read of recommended apps ([a6b9d33](https://github.com/haikal-dev/puter/commit/a6b9d33d27909ead3d14eff4446062d62aad4651))
* fix fallback icon behavior in get_icon_stream ([4f3a161](https://github.com/haikal-dev/puter/commit/4f3a1618b10dd393f5c94c0967beb228a593b214))
* fix for previous fix ([648d6e0](https://github.com/haikal-dev/puter/commit/648d6e036d6f8040a1e440c1e76dc9dcc746156f))
* fix microcents to USD conversion in AIChatService ([dcd47bc](https://github.com/haikal-dev/puter/commit/dcd47bc4cfc5f8a67ea86e0485d08c2417f899ed))
* fix name and id for openai tool calls ([d2358d2](https://github.com/haikal-dev/puter/commit/d2358d234b45d719a2cc4e92582ed89d2d1832ab))
* fix previous fix ([e5c3769](https://github.com/haikal-dev/puter/commit/e5c3769bd813b1510dd0429e1e4eca8e277af7c7))
* get event docs back in sync ([e6b3cb3](https://github.com/haikal-dev/puter/commit/e6b3cb36665b51c5b7cc88f13513bf71c36a4f3a))
* **gui:** clock padding moving other elements ([8edcf75](https://github.com/haikal-dev/puter/commit/8edcf7575d242e30b6c88eb1e9f91c3017835f6c))
* **gui:** color of the UI on dark mode (e.g. windows control, active sidebar) ([#1161](https://github.com/haikal-dev/puter/issues/1161)) ([33c3048](https://github.com/haikal-dev/puter/commit/33c304879a5fe4db6f0be10fce87629d40db31b1))
* **gui:** logo placement with no clock using margin ([5c50eb1](https://github.com/haikal-dev/puter/commit/5c50eb1f8bbb5eb9e9ef9e529f82d1b953fd7e84))
* I'ma buy GitHub a coffee and spill it on their servers if this works ([686d3de](https://github.com/haikal-dev/puter/commit/686d3de518e6e090d683294ad3dd856db26856a0))
* icons ([d03952b](https://github.com/haikal-dev/puter/commit/d03952b23712ae8a61c7f2c7582d297691e0ecc1))
* improper 500 in wisp token verify ([75aaaa6](https://github.com/haikal-dev/puter/commit/75aaaa66a8c7df00e1fb80c353d890269296839c))
* incorrect addition of https prefix for peers ([41d5dbc](https://github.com/haikal-dev/puter/commit/41d5dbc0da771ecab47cd477a5ed91b3f65709db))
* issues with thread subscriptions ([252647c](https://github.com/haikal-dev/puter/commit/252647cea6c2202a2a2ba61f9e026189810ef889))
* let messages with tool_calls have content=null ([29c0241](https://github.com/haikal-dev/puter/commit/29c024111943267b741b1b4a8933e1ea1a35a65e))
* made protocol dynamic in the publishURL displayed on 'Publish As Website' dialogbox ([#1170](https://github.com/haikal-dev/puter/issues/1170)) ([6236d00](https://github.com/haikal-dev/puter/commit/6236d00ea2324a8c4e05a57181d0d2318f33584e))
* message coercion bug affecting vision ([ec0a721](https://github.com/haikal-dev/puter/commit/ec0a72114382a78d82bc7d0156daf1a2a003d567))
* message coercion for tool call message ([d66e38c](https://github.com/haikal-dev/puter/commit/d66e38cc667073603d4368095d4e0bc277218f90))
* missing changes to run-selfhosted.js ([6f4b1bf](https://github.com/haikal-dev/puter/commit/6f4b1bf94a031b3324f5ecd51557b1298a1c3175))
* missing ll_copy import ([8a9164d](https://github.com/haikal-dev/puter/commit/8a9164d7c5380aafb864b56ca1a3ee59f24daf38))
* missing parent dirs created in move ([9d9d97f](https://github.com/haikal-dev/puter/commit/9d9d97fd0074058506b0506d5027b0c6b8a26845))
* missing some buffer contents in no-keepalive ([3f5b34c](https://github.com/haikal-dev/puter/commit/3f5b34cd341b9063d01baba72e708a9ebb16485b))
* mistake in 0c42613 ([8ffd000](https://github.com/haikal-dev/puter/commit/8ffd0004b3b7b34cd6a9c43c6ca960c7a1cbbe15))
* mkdir with create_missing when some parents exist ([807c3ba](https://github.com/haikal-dev/puter/commit/807c3ba5eca02f69b5e6ce547420312b68c7993f))
* move AppCommandProvider to the end ([870e4aa](https://github.com/haikal-dev/puter/commit/870e4aa93807f1fcd37af29d9369737ab9f4b4b1))
* new desktop height calculation when resizing browser window ([a295420](https://github.com/haikal-dev/puter/commit/a295420f58326b04c976cf92bd2d582d2eafa71b))
* new edge cases with function calls / tools ([9cbb741](https://github.com/haikal-dev/puter/commit/9cbb741a8ae8ea6b869b6ccf64cd3152b28c2b8c))
* o3 tools with array parameters ([2ee380e](https://github.com/haikal-dev/puter/commit/2ee380ec16789525c9f0b782fb4af1e193ddd232))
* oh, right; there's two of them ([a13af7e](https://github.com/haikal-dev/puter/commit/a13af7e31aa4cd36457a90a7d75878b6d39ba73b))
* oops we still need that ([61824ea](https://github.com/haikal-dev/puter/commit/61824ea04b0cb7611d2acdf45e0a1ecc2856901a))
* oops, no export (putility.libs.event) ([fa4b38c](https://github.com/haikal-dev/puter/commit/fa4b38cd028be4b19ec98bcf588227e0fc92af9d))
* oops, we're passing negative values; let's just remove this ([cf7aa27](https://github.com/haikal-dev/puter/commit/cf7aa27543700d6268ee709f127e73f7cfe12a5a))
* parse body before auth for /down ([70fde95](https://github.com/haikal-dev/puter/commit/70fde95255532a7fe0d99c64a4efb1ae625776a4))
* parser error for empty json buffer ([484bb5c](https://github.com/haikal-dev/puter/commit/484bb5c201e17bf45e1a1d97b1e9b2d61d6087dc))
* path update in legacy rename behavior ([7e82c94](https://github.com/haikal-dev/puter/commit/7e82c947b1070b4a42798f7ae84bfaee8c3b54c9))
* permission request 500 errors ([3276faa](https://github.com/haikal-dev/puter/commit/3276faa5f09163a924316fac1a175ddeb0724e61))
* phoenix changelog ([0bcbc8f](https://github.com/haikal-dev/puter/commit/0bcbc8f7845de99305f53c6da2bb1f365b87ac50))
* possible out-or-order response objects from batch ([fb70251](https://github.com/haikal-dev/puter/commit/fb7025164e3f42cae1365ec65960019b24f4360d))
* potential fix for /down auth ([390230c](https://github.com/haikal-dev/puter/commit/390230c5a07b1774f84a1b3505f7531ce81dc2cc))
* prefix peer addresses with protocol ([efd4730](https://github.com/haikal-dev/puter/commit/efd4730f757471c3eac2d5e396dd69b619ad2999))
* puter subdomain error response ([cfa5c7e](https://github.com/haikal-dev/puter/commit/cfa5c7e715405a0f92dc798195edc25f66b2b83b))
* race condition and buffer issue in puter.http ([36dc966](https://github.com/haikal-dev/puter/commit/36dc9664ad5520b21c07a1b5c85c8aff7cbe423b))
* recursive delete error ([7e76b65](https://github.com/haikal-dev/puter/commit/7e76b657bb2fe811d437598471e52744a6276088))
* reduce code paths for querystrings ([e8f5450](https://github.com/haikal-dev/puter/commit/e8f5450cb05213c3c06802442103f5c414eee5cc))
* remove hard-coded token limit for OpenAI ([8143e57](https://github.com/haikal-dev/puter/commit/8143e5700f53279a5a18d21b7c5466f3b9bb6ce6))
* remove log from InternetModule ([c7f3e0b](https://github.com/haikal-dev/puter/commit/c7f3e0b937f5d72d6f30dba25d7c351e2e14f289))
* remove redundant notification query ([f87769b](https://github.com/haikal-dev/puter/commit/f87769b445d53e6322a55a788e26d38629299ae9))
* repair stream end ([8f27742](https://github.com/haikal-dev/puter/commit/8f277420380e9c6fa8a9925a3e9651f48b8734e6))
* reposition clock to right ([#1181](https://github.com/haikal-dev/puter/issues/1181)) ([505e7ab](https://github.com/haikal-dev/puter/commit/505e7abda2df6109b1e322595c8442719403757f))
* revert test change ([9c86614](https://github.com/haikal-dev/puter/commit/9c86614df5d58ca0385450e1edb5adb5b6d72300))
* rewrite confusing log message ([dacbbf0](https://github.com/haikal-dev/puter/commit/dacbbf033dcc0f4506198761eab3bfb6ef915336))
* save_account case for disable_user_signup ([766c235](https://github.com/haikal-dev/puter/commit/766c235cc738051588a67ff5ab4230e76b64173c))
* **security:** patch express via path-to-regexp ([d081c4f](https://github.com/haikal-dev/puter/commit/d081c4f2fe8357ef8aa35790a794509a8e188fb7))
* share only emails email_confirmed recipients ([2336a62](https://github.com/haikal-dev/puter/commit/2336a62b4f635c025b02bb7efe91b5ddf58bae25))
* shortcut issue ([6d196d5](https://github.com/haikal-dev/puter/commit/6d196d59f026bec4acb0296d8f0f38c7cee2e8c2))
* skip request-count usage check via AIChatService ([6083e3a](https://github.com/haikal-dev/puter/commit/6083e3ac52fcde7f598c838bc49085e6b3de7162))
* skip test files in mod lib loading ([f60c008](https://github.com/haikal-dev/puter/commit/f60c008158127458e02e3bb92287617d9f1f9514))
* small fixes for threads ([96199cb](https://github.com/haikal-dev/puter/commit/96199cbb54c8e4cbe3205a507de606811e893130))
* small workaround for duplicate close ([06452f5](https://github.com/haikal-dev/puter/commit/06452f5283085b18266ee7fb89136b9c23879243))
* subdomains to deleted files tried to deref fs node ([38ccc82](https://github.com/haikal-dev/puter/commit/38ccc82c8e95636ee4b7c5ca2f761098f12affa2))
* temperature and max_tokens (interface + OpenAI) ([03045e2](https://github.com/haikal-dev/puter/commit/03045e2737084b838323c49bef8cebc8e9e39a27))
* terminal not loading in self-hosted ([803f440](https://github.com/haikal-dev/puter/commit/803f440d55fc73d59771fadc7484d5280234a5ab))
* test and improve boolify ([44ad3c5](https://github.com/haikal-dev/puter/commit/44ad3c578106d2b01007240188db57760c15af96))
* test for get-launch-apps ([740fdb5](https://github.com/haikal-dev/puter/commit/740fdb592e494bf5b197493774cef6559bfb50b9))
* thread delete events ([3e74f42](https://github.com/haikal-dev/puter/commit/3e74f42c4d1c0519e4e89d939b4af416ce008737))
* thread subscription updates across regions ([76bedf5](https://github.com/haikal-dev/puter/commit/76bedf5f8ff3167eb6bf5ff71f7cc06c74f62d23))
* timing for PrefixLogger call to /whoami ([2dc6c47](https://github.com/haikal-dev/puter/commit/2dc6c4737b9ec9db281b4b32ed4bd20ac490e47d))
* try catching icon read errors before stream ([e56a62c](https://github.com/haikal-dev/puter/commit/e56a62c5390958e585f299751bafd13becc1c9b6))
* try catching on stream_to_buffer ([ada051b](https://github.com/haikal-dev/puter/commit/ada051b9b87e945b4a80c1fae99b8c5644b82dc0))
* try redundant npm install after build stage ([8963eb0](https://github.com/haikal-dev/puter/commit/8963eb0c4f1220dd515ac6ed7a2a8f1de26655ae))
* unfixed fix from earlier ([e6fc773](https://github.com/haikal-dev/puter/commit/e6fc7737066d09509f0c7b38e4c51f25e86e12d0))
* update package.json ([c2c5d88](https://github.com/haikal-dev/puter/commit/c2c5d883365ae33749709d11e0c2de9050ca144e))
* use .get() for Map lookup. fix: correctly set url and url_paths. fix: null check to throw error. ([78ac033](https://github.com/haikal-dev/puter/commit/78ac033a1ca4f51b71c2bcb185b305903f7be495))
* various issues with Mail module ([55d052c](https://github.com/haikal-dev/puter/commit/55d052cfc2549bfdf72f3a8b27cdc7dc4294bc54))
* wisp relay authentication ([6f39365](https://github.com/haikal-dev/puter/commit/6f39365b24cda53a6cac7e203b9d8cbc09bb0ba3))
* wrong parameter count ([26591e4](https://github.com/haikal-dev/puter/commit/26591e4171d41f402efa78201dd5308ec419b26c))


### Performance Improvements

* multiple kv keys ([5a68691](https://github.com/haikal-dev/puter/commit/5a68691290f1c34883cd093b4df2fb7f8ac6252c))
* optimize recommended apps ([a504c6b](https://github.com/haikal-dev/puter/commit/a504c6ba2a1f6f68ddef2fbeed001ea5be26e830))
* reorder get-launch-apps behavior ([2a50736](https://github.com/haikal-dev/puter/commit/2a5073687db320e73beec29301e088eb0ed79b4f))
* single request for gui boot kv keys ([fd6f8bf](https://github.com/haikal-dev/puter/commit/fd6f8bf2256af361ea9853fc61aee2b0101b6c4a))
