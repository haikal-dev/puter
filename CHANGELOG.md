...
* add -c flag for phoenix ([b6c0cb6](https://github.com/haikal-dev/puter/commit/b6c0cb6abc1c29846b4b7e696812476bea24bbc7))
* add an 'Upload' button at the bottom of `OpenFilePicker` ([54ae69b](https://github.com/haikal-dev/puter/commit/54ae69b7b76016307c3b92437ca06dc2aa1eddb9))
* add config for blocked email domains ([955b087](https://github.com/haikal-dev/puter/commit/955b087297f829b11b82dc9bd79a0e03721c5f33))
* add error handling to the share flow ([b5bb95e](https://github.com/haikal-dev/puter/commit/b5bb95e2d7f6021a6341e26cf15d5449ada48830))
* add extension API for modules ([14d45a2](https://github.com/haikal-dev/puter/commit/14d45a27edb99f63b4f6e010221e3a0880ae246d))
* add puter.auth.whoami() ([da0022a](https://github.com/haikal-dev/puter/commit/da0022abf0f880c7b52d2cd937ef9d1298fc09cc))
* add puter.log ([755736e](https://github.com/haikal-dev/puter/commit/755736edee9baa783be9b7d96083d908a2f2f750))
* add support for `fadeIn` effect for `UIWindow` ([13248a9](https://github.com/haikal-dev/puter/commit/13248a99bfa318e84cb99e2954a5f46805eda34f))
* add support for categories in the Dev Center ([7cf215a](https://github.com/haikal-dev/puter/commit/7cf215ab677e3fc912a3bd1ac52795c1e8860c32))
* add support for extensions ([b018571](https://github.com/haikal-dev/puter/commit/b018571a86f4114eab9b5edde4ecd87e343d22a7))
* **ai:** add xAI grok-beta ([28adcf5](https://github.com/haikal-dev/puter/commit/28adcf533fd867dfdf3bda0007753e65c91ff5e5))
* allow `launchApp` to open explorer at a specific path ([8fefd4a](https://github.com/haikal-dev/puter/commit/8fefd4a61f0005d4f3ec2e43f7249f3edd91c837))
* Allow apps to toggle `credentialless` via Dev Center ([af511c0](https://github.com/haikal-dev/puter/commit/af511c05e3ddddcce661c5406d5c831a21689608))
* allow developers to set social media images for their apps ([be36d31](https://github.com/haikal-dev/puter/commit/be36d31509280340e2a62a8c478b1e64617792a4))
* allow passing cli args via url ([5317adf](https://github.com/haikal-dev/puter/commit/5317adf8a4961be3f0ca2a8c403c922633f934fa))
* automatically open the browser when starting Puter ([2d43129](https://github.com/haikal-dev/puter/commit/2d4312972a1377a64732694811fe889f59573432))
* **backend:** add comments for fsentries ([db79a72](https://github.com/haikal-dev/puter/commit/db79a72daab5460bc8e24f6e16c6280291b2f6fe))
* collapsible sidebar menu in Dev Center ([1056231](https://github.com/haikal-dev/puter/commit/1056231004a629f3f76f2525ec7d83b67d3d7fa5))
* customize the order of Explorer sidebar items ([ff30de1](https://github.com/haikal-dev/puter/commit/ff30de1d6947e4692b5cf0da2e19ab37aacf1ec8))
* first extension that implements a custom user options menu ([fc5e15f](https://github.com/haikal-dev/puter/commit/fc5e15f2a6d4eb5e5847fa7f2dd87b1fa382fc7c))
* handle `notif.ack` in desktop ([a6650ee](https://github.com/haikal-dev/puter/commit/a6650ee2d8074aeb7c476e5572334853f1b6d7e8))
* **i18n:** update Urdu localization with missing translations ([0c4b994](https://github.com/haikal-dev/puter/commit/0c4b9946442ad92549522fcd91ea6aefbb9f19d6))
* Implement profile pictures ([0885937](https://github.com/haikal-dev/puter/commit/0885937f033caf35503eeb9e65bb390952992faf))
* in Share window, display access level next to recipient ([cf4b6aa](https://github.com/haikal-dev/puter/commit/cf4b6aa1c24d936f9a42ca1e2945eea40939c970))
* progress indicator for emulator ([08601ae](https://github.com/haikal-dev/puter/commit/08601ae2af7b1f564690e6a9cae7e689cb7ba48a))
* puter.js's showSpinner() will keep the spinner active for at least 1200ms ([fc5aca1](https://github.com/haikal-dev/puter/commit/fc5aca1f72de22c1530054272b55a59021ba9caa))
* **putility:** trait method override support ([43c5402](https://github.com/haikal-dev/puter/commit/43c5402b7cb92e604cbe59badc8f735131d2c349))
* Reaload App option in the window title bar context menu ([27c01c9](https://github.com/haikal-dev/puter/commit/27c01c9bd991ef871153eb5931f78fec265a62e4))
* Require email confirmation before sharing ([cdd1a8c](https://github.com/haikal-dev/puter/commit/cdd1a8c4e379b885ff48a874ae5577d2f0efae06))
* search ([55d2af1](https://github.com/haikal-dev/puter/commit/55d2af189e9479fb5980ce149ce74e890b325014))
* search endpoint ([b589512](https://github.com/haikal-dev/puter/commit/b589512c9dedec22fd41b92cbba2570042149873))
* show profile pics in sharing notifications ([0e45132](https://github.com/haikal-dev/puter/commit/0e45132c05aa1106503fef02b7e4c97ecc675e10))
* show unread notification count in the browser tab's title ([045259c](https://github.com/haikal-dev/puter/commit/045259cefbe24e3f52fe3840e4975d3243e99957))
* spinner for the `showWorking()` overlay in puter.js ([1062363](https://github.com/haikal-dev/puter/commit/1062363096418f164a6d00ed8872770ff64237b5))
* support readdir for directory symlinks ([7f1b870](https://github.com/haikal-dev/puter/commit/7f1b870d302421972c4f6221ae6d93b5979d51dd))
* the `socialLink` UI component ([1adfe5c](https://github.com/haikal-dev/puter/commit/1adfe5c70947d9de008c9d601f91b1ee14128d5d))
* translate README.md to Dutch ([31e2773](https://github.com/haikal-dev/puter/commit/31e2773743c336630c917e893b0148441f5fc515))
* v86 9p server support ([b145e30](https://github.com/haikal-dev/puter/commit/b145e30a90ff2f0d44d89f83dbda4de1bf2991d4))
* welcome screen to quickly explain what Puter is ([564ff65](https://github.com/haikal-dev/puter/commit/564ff65363258cab4196b967dd556105e424d48c))
* when sharing, users can choose between 'viewer' and 'editor' for permissions ([0cbe013](https://github.com/haikal-dev/puter/commit/0cbe0139d7f306ce62992f1eda94d99e09b32df8))


### Bug Fixes

* `launchApp` on explorer supports `~` now ([e482b00](https://github.com/haikal-dev/puter/commit/e482b00a303ca7ec0230be1924334d59adc00f8e))
* 1954f8-related issue ([f5865da](https://github.com/haikal-dev/puter/commit/f5865daede2b32682d0472926bc5db65c9ef37ab))
* 1954f8-related issue [#2](https://github.com/haikal-dev/puter/issues/2) ([143cfb5](https://github.com/haikal-dev/puter/commit/143cfb5654eca8b50fb7ff434f47db24d7bdf3aa))
* add missing id for task_manager menu item ([4f9d9a5](https://github.com/haikal-dev/puter/commit/4f9d9a54efb3c5177125904a1c9ddec66ca089dc))
* add mixxing context to BroadcastService ([665471f](https://github.com/haikal-dev/puter/commit/665471f9f02b1f1163edb47932a31f52577ee7df))
* add placeholders ([2c86240](https://github.com/haikal-dev/puter/commit/2c862403994ff6385144841db07dcc94c5c2fc2e))
* add progress bar fix ([a70d0dd](https://github.com/haikal-dev/puter/commit/a70d0dd0881b0a07cea404fe13515a5e10321e3e))
* add username to comments ([085d808](https://github.com/haikal-dev/puter/commit/085d808817e985f2bc52b7a91a31991ca3b2e89f))
* allow ETX to propagate to bash ([259877b](https://github.com/haikal-dev/puter/commit/259877b677a7bfc8e5b377c8852d687978c9bc24))
* allow scrolling of user list in share window ([905b5d8](https://github.com/haikal-dev/puter/commit/905b5d851ef68d923d8f7fbaddbe214cb812bae6))
* always adapt model for ClaudeEnough ([56710e1](https://github.com/haikal-dev/puter/commit/56710e17f3b06eef07e54c243f6b725fcc4a4583))
* app close issue in phoenix ([38adb57](https://github.com/haikal-dev/puter/commit/38adb5741b241081dd3f30de2f9afdd708cc9fa5))
* app pseudonym in wrong conditional block ([9985996](https://github.com/haikal-dev/puter/commit/99859966866ebce005f88e3a916c68dc04ba97bf))
* attempt at fixing broadcast ([22dd42e](https://github.com/haikal-dev/puter/commit/22dd42ef7f64d32ada0c776287f53a80a4470315))
* automatically open browser when starting only if in dev env ([f500fb4](https://github.com/haikal-dev/puter/commit/f500fb47061f8f3a3dc7d871cb529f5c0b058185))
* capitalize `Hindi` in i18n ([35fd158](https://github.com/haikal-dev/puter/commit/35fd15854ad3cc92924c4ded752e337f467a7125))
* Collector bug on undefined body ([14f477a](https://github.com/haikal-dev/puter/commit/14f477a6330c9169145a7f8b2721d02e7517513b))
* configuration for browser launch ([791f774](https://github.com/haikal-dev/puter/commit/791f7748c7c1959f63327a73a7e24e41b574a910))
* continue work on blocked_email_domains ([515051d](https://github.com/haikal-dev/puter/commit/515051dabf9f2a145ae2d090f829df7188e9fd28))
* continue work on blocked_email_domains (2) ([4dc1e01](https://github.com/haikal-dev/puter/commit/4dc1e01682571f16a25eebb2e9c7918587ca89ae))
* creating app shortcut in self-hosted ([38dcb60](https://github.com/haikal-dev/puter/commit/38dcb60d3f407dd185999d01d8e14355b47df0b8))
* **deps:** update multiple dependencies ([70096a8](https://github.com/haikal-dev/puter/commit/70096a8d6f5492170018073698ee70b930a06d85))
* disable thumbnails for AppData uploads ([37e7b6a](https://github.com/haikal-dev/puter/commit/37e7b6ad70f197db3be8712315446079caa23892))
* disabled sortable on sharing section in the sidebar ([9d7987f](https://github.com/haikal-dev/puter/commit/9d7987fae50b510f1836e306d5f6f497a560de08))
* don't access `metadata.credentialless` if it doesn't exist ([9590bbd](https://github.com/haikal-dev/puter/commit/9590bbdad1099cf75d6073663a9fcec5f3136482))
* don't allow sharing with recipient just shared with ([d0f16c8](https://github.com/haikal-dev/puter/commit/d0f16c810509c7e4e8acba3408c71655664cfad2))
* don't check share permission anymore ([249dc06](https://github.com/haikal-dev/puter/commit/249dc062014947c32bee8a8238b2c8acf86188bb))
* don't display all apps for extensionless files ([010282e](https://github.com/haikal-dev/puter/commit/010282edf299c2a39e53de7441b8850d0b8011b8))
* don't show kvstore in usages ([402ffb0](https://github.com/haikal-dev/puter/commit/402ffb0fd1e812a8db8ea90ac53ed613fdd30a4b))
* error deleting entry from My Websites window ([fff8993](https://github.com/haikal-dev/puter/commit/fff89932002d67bf0f121532709c871263e33473))
* error in process.handle_connection ([cb324cc](https://github.com/haikal-dev/puter/commit/cb324cc125285b5cd6a6b0cebf444a6cd873ded9))
* errors thrown by launch_app ([c22a69f](https://github.com/haikal-dev/puter/commit/c22a69ffb1809ad7959f8a8fe934052369b5d44f))
* files shared array in notification ([27cc07e](https://github.com/haikal-dev/puter/commit/27cc07e985a799fae791d6edf61b7e656e0e182e))
* give camera and recorder write permission to Desktop ([65e6d6c](https://github.com/haikal-dev/puter/commit/65e6d6c09fd464b3fea979689fab5f26a2647c4a))
* groups manager location ([a08e975](https://github.com/haikal-dev/puter/commit/a08e9758fe7625d31279b8947a4e5ca6471578ff))
* height 100% on flexer and step view ([c6bc42f](https://github.com/haikal-dev/puter/commit/c6bc42f551a46919b4b70a9ae3dfec85086b0233))
* hyphenize_confirm_code bug ([463c96c](https://github.com/haikal-dev/puter/commit/463c96c69a915ea75db66fd449e83a61ca036f6f))
* ignore invalid entries from service_usage_monthly ([f108795](https://github.com/haikal-dev/puter/commit/f1087953b57297a1e066ea68563e8a273a1af4c0))
* image generation supports test mode ([f533dca](https://github.com/haikal-dev/puter/commit/f533dca1a6d88ca7a14bd69f15d0a151e24c58e1))
* issue with context menu divider item stealing the event from previous item ([121043d](https://github.com/haikal-dev/puter/commit/121043d312577a6e048497108309cd08b73df4d0))
* issue with non-scrollable window body and document Context Menu ([0315cb3](https://github.com/haikal-dev/puter/commit/0315cb333719b08c6581b556c69a14cbe671b7bd))
* issue with popover closing when clicked ([ac3317a](https://github.com/haikal-dev/puter/commit/ac3317aea918953358947638ca11822baa38e23f))
* issue with service scripts that use TestView ([e0b9072](https://github.com/haikal-dev/puter/commit/e0b90721299fa3013f66c866ba637c52efe9df1d))
* issues in kdmod ([0a47daa](https://github.com/haikal-dev/puter/commit/0a47daa2896d97c318aec2e2288f61ade5f4ea48))
* logging in AppConnection ([5caa2c0](https://github.com/haikal-dev/puter/commit/5caa2c0e3a152d1fc947b86329778db462139db0))
* mobile detection ([b11016d](https://github.com/haikal-dev/puter/commit/b11016dab321717f2c367e985167a4689fc02814))
* mobile-friendly taskbar ([7a7c14f](https://github.com/haikal-dev/puter/commit/7a7c14fb040b28ef769abdba41b50d88c856fb20))
* new sessions miss notifications ([b1ffb8e](https://github.com/haikal-dev/puter/commit/b1ffb8eca13520fa41833f5361ff6a6505a80a2c))
* notepad save issue ([bc51d4b](https://github.com/haikal-dev/puter/commit/bc51d4bd52b5d0a7bb4feddea7bb9d73e449f7d8))
* occasional db error from notics ([9e303a2](https://github.com/haikal-dev/puter/commit/9e303a2f7c7bf6ac9032e6c9b87bffd3126baa86))
* only add enabled_logs when not empty ([34836e3](https://github.com/haikal-dev/puter/commit/34836e374fccac297a6f0fa5f323f3609d0c9179))
* only allow UserActorType for ShareService ([69bfa60](https://github.com/haikal-dev/puter/commit/69bfa601993eb6c47c3555b92559878d76ba749e))
* permission grants in open_item ([16257a7](https://github.com/haikal-dev/puter/commit/16257a7b5459550ee3782cf32c87a8241325878d))
* persist clock visibility change ([1a6d648](https://github.com/haikal-dev/puter/commit/1a6d648a6ecdda07b23da9e6f4ef49b70b54cce1))
* phoenix incorrect lookup order ([c8f913d](https://github.com/haikal-dev/puter/commit/c8f913d710454d0ab3da2147309b442a78965720))
* potential null-or-undefined in DriverService ([01725ff](https://github.com/haikal-dev/puter/commit/01725ffebf86ed332087c877956e59570ea700ed))
* prevent code from breaking just because it was bundled ([fb1216d](https://github.com/haikal-dev/puter/commit/fb1216d488bed8ee8d88c7c71e4a6f1054e3a01c))
* prevent permission cycles ([e0128aa](https://github.com/haikal-dev/puter/commit/e0128aa88c54548304532282e5ed1b4a2d36ff3e))
* previous fix ([ee7bedd](https://github.com/haikal-dev/puter/commit/ee7bedd5586d69ce74f32c1400f377d6a8971eaa))
* properly add owner object to fsentries ([04c05a5](https://github.com/haikal-dev/puter/commit/04c05a5bb8b73dda21093a2bf563f5cd6faaa356))
* quick patch to avoid columnify error ([4396534](https://github.com/haikal-dev/puter/commit/439653458eab38e622cf215ae96b6af34d1db7d4))
* reading JSON string from service_usage_monthly ([b30de5b](https://github.com/haikal-dev/puter/commit/b30de5bf786ae8f28f3248277c5b2df2f0e5ebf4))
* recently broke counting service sql ([7ba16d1](https://github.com/haikal-dev/puter/commit/7ba16d1c21d07e58cefebf967e5ca2b74502e841))
* reinitialize settings tabs for DOM events ([16b9f09](https://github.com/haikal-dev/puter/commit/16b9f09e66ffe1584f925cb1a9f261bc159c8dda))
* remove redundant openai model fallback ([9db55fc](https://github.com/haikal-dev/puter/commit/9db55fc5f7a975ab301c88bbac493b7a5b1933bb))
* replace ll_readshares with better approach ([cd22425](https://github.com/haikal-dev/puter/commit/cd22425a3d363f6008b3d07f40a082769ee22a14))
* report path for broken files as /-void/ ([5725bd8](https://github.com/haikal-dev/puter/commit/5725bd8c66539564e7f58f96c6e81044a3751f97))
* Resolved issue [#848](https://github.com/haikal-dev/puter/issues/848) - Ukrainian translation ([ee705e5](https://github.com/haikal-dev/puter/commit/ee705e5c1ca08b9b3a8d809ae3dac0158abb24c9))
* safe parsing of app metadata ([a2c7b37](https://github.com/haikal-dev/puter/commit/a2c7b379f8181b373b0513d9166f75adc147aafa))
* second half of connectToInstance ([4311b48](https://github.com/haikal-dev/puter/commit/4311b482fd629c6d1f65956eb711c8e890453179))
* **security:** always use actor ([1954f86](https://github.com/haikal-dev/puter/commit/1954f86680be642e1af03f648d6b587fe67dfaa8))
* service usage screen ([193da63](https://github.com/haikal-dev/puter/commit/193da633044f463ec1ed60eca4608761fc40b1d7))
* share issue with prefix usernames ([d30d62f](https://github.com/haikal-dev/puter/commit/d30d62f558ca5f8c74090900aa39c13ca3ca1d2e))
* sharing notification click opening directories ([bfacfc2](https://github.com/haikal-dev/puter/commit/bfacfc2a4e4b50c9e0842f9f2d56de67a598b959))
* small issue in Service.js ([3c5d2af](https://github.com/haikal-dev/puter/commit/3c5d2af8c8341ef78236ef38153ed0b4f20c5cac))
* temporary fix because .on can't call ensure_service ([f836ac3](https://github.com/haikal-dev/puter/commit/f836ac30a901a7b3258399a54eab5c7c8cc47463))
* thumbnail service updates ([c2a9506](https://github.com/haikal-dev/puter/commit/c2a9506b4855f67d320eb479a67800098d73e8ec))
* turns out we don't support `utm_source` I learn something new about Puter every day! ([99ce3bd](https://github.com/haikal-dev/puter/commit/99ce3bde199de729c4796a681c188c4a0da9165e))
* un-awked notif check in wrong place ([3f3f4e6](https://github.com/haikal-dev/puter/commit/3f3f4e6cb9fd3faad2e87fbf9ea1f09b934151ca))
* update apps cache by reading from primary db ([e8f67da](https://github.com/haikal-dev/puter/commit/e8f67da9a3d81273f59d136c8383f00d9dc8ca5a))
* Update security.txt canonical URL ([6c44032](https://github.com/haikal-dev/puter/commit/6c44032293836871a27fb3c857a0ff3b80462702))
* update share email ([7e7234b](https://github.com/haikal-dev/puter/commit/7e7234b2f3fb89560108447cfd7fa87499ec6f38))
* usage bug ([0fd3b1e](https://github.com/haikal-dev/puter/commit/0fd3b1e61157d989d55e6dacba2add0e03d260e7))
* use correct cursor when hovering over sidebar items ([c44b9ab](https://github.com/haikal-dev/puter/commit/c44b9ab8d5f575393bf864fd30235287f845a4e8))
* wait no ([12e0cec](https://github.com/haikal-dev/puter/commit/12e0cecf02f4d906035a6f0059557416475db106))
